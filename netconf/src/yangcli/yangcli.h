...
#define YANGCLI_DEF_HISTORY_FILE  (const xmlChar *)"/etc/yuma/.yuma/.yangcli_history"

#define YANGCLI_DEF_ALIASES_FILE  (const xmlChar *)"/etc/yuma/.yuma/.yangcli_aliases"

#define YANGCLI_DEF_USERVARS_FILE \
    (const xmlChar *)"/etc/yuma/.yuma/yangcli_uservars.xml"
