...
*
* Setup the /etc/yuma/.yuma directory if it does not exist
*
* RETURNS:
*   status
*********************************************************************/
...
*
* Setup the /etc/yuma/.yuma/tmp directory if it does not exist
*
* RETURNS:
*   status
*********************************************************************/
    ...
    ncxmod_setup_tempdir (void)
{
    ...
    if (dp == NULL) {
        ...
        /* use the existing /etc/yuma/.yuma/tmp directory */
        (void)closedir(dp);
    }
    ...
    ncxmod_new_program_tempdir (status_t *res)
{
    ...
    *p++ = NCXMOD_PSCHAR;
    ...
    /* try to open /etc/yuma/.yuma/tmp/<progstr> directory */
    dp = opendir((const char *)tempdir_path);
    if (dp == NULL) {
                                ...
                                status_t *res)
{
    ...
    *p++ = NCXMOD_PSCHAR;
     ...
     * try to open /etc/yuma/.yuma/tmp/<progstr>/<sidnum> directory */
